    ...
    return (
      <Form onSubmit={this.manualRegisterToBC}>
        ...
        <Alert bsStyle="success" style={{ display: this.state.register_result_show ? 'block' : 'none' }}>
          ...
          <br />
          <strong>Tips:</strong> Click <a href='https://github.com/BlockMedical/BlockMedical/blob/master/docs/metamaskdocs/add_token_symboles/README.md' target='_blank'>here</a> to see how add symbol to your wallet.
        </Alert>
      </Form>
    );
  }
