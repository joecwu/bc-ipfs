...
const lib_trading_contract = new lib_web3.eth.Contract(abi, address, { gasPrice: CONFIG.ethereum.trading_contract.gasPrice, gas: CONFIG.ethereum.trading_contract.gas });
